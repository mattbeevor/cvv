...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "cvv@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "cvv API";

        private String description = "cvv API documentation";
